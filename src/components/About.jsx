...
export default function About() {
  ...
  return (
    <section id="about" className="py-20 bg-white dark:bg-gray-900 transition-colors duration-300 ease-in-out">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.h2
            className="text-3xl sm:text-4xl font-extrabold text-gray-900 dark:text-white tracking-tight mb-4 transition-colors duration-300 ease-in-out"
            variants={itemVariants}
          >
            About Me
          </motion.h2>
          <motion.div
            className="h-1 w-20 bg-blue-600 dark:bg-blue-500 mx-auto rounded-full transition-colors duration-300 ease-in-out"
            variants={itemVariants}
          />
        </motion.div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-3">
          ...
          >
            <motion.p
              className="text-gray-700 dark:text-gray-300 leading-relaxed transition-colors duration-300 ease-in-out"
              variants={itemVariants}
            >
        ...
        >
          ...
          <div className="w-72 h-72 md:w-80 md:h-80 [perspective:1000px] mx-auto group">
            <div className="relative w-full h-full transition-transform duration-700 transform-style-preserve-3d group-hover:rotate-y-180">
              ...
              {/* Back Side */}
            <div className="absolute w-full h-full backface-hidden rotate-y-180 bg-[#169948] text-white flex flex-col items-center justify-center rounded-xl px-6 py-4 text-center space-y-4 transition-colors duration-300 ease-in-out">
              {/* Professional Headline */}
              <h3 className="text-lg md:text-xl font-semibold transition-colors duration-300 ease-in-out">Software Developer</h3>

              {/* Intro Summary */}
              <p className="text-sm md:text-base leading-relaxed transition-colors duration-300 ease-in-out">
              ...
              <div className="flex justify-center items-center gap-4 mt-4 relative top-2 sm:top-3"> {/* Added margin-top for spacing */}
                ...
                <a
                  ...
                  className="text-white hover:text-blue-200 transition-colors duration-300 ease-in-out"
        ...
        > */}
          {/* {personalTraits.map((trait) => (
            <motion.div key={trait} variants={itemVariants}>
              <Badge
                variant="secondary"
                className="px-4 py-2 text-sm bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200 rounded-full font-medium shadow-sm hover:shadow-md transition-all duration-300 ease-in-out"
              >
                {trait}
              </Badge>
            </motion.div>
