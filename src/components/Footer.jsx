...
const Footer = () => {
  ...
  {[
    { icon: Github, href: "https://github.com/sanjayyshrestha", color: "hover:text-white" },
    { icon: Linkedin, href: "https://www.linkedin.com/in/sanjayyshrestha7/", color: "hover:text-blue-400" },
    { icon: Mail, href: "mailto:sanjayshrestha772@gmail.com", color: "hover:text-red-400" },
